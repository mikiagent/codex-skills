...
- background is fully transparent alpha
- no backdrop, background pixels, gradients, floor plane, cast/contact shadow, glow field, or matte rectangle
- no text
- no labels
- no UI
- no speech bubbles
...
- leave transparent padding on all four sides
